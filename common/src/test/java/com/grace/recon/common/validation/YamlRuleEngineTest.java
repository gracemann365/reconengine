...
""";
  ...
  void testLoadRulesSuccess() {
    ...
    // Test that known rule sets exist by attempting to validate against them (expecting no
    // ValidationException for rule set not found)
    ...
    ValidationException thrown =
        assertThrows(
            ...
            () -> ruleEngine.validate("non-existent-rules", new HashMap<>()));

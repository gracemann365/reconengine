...
class InputSanitizerTest {
    ...
    void testSanitizeHtml() {
        assertEquals("&lt;script&gt;alert(&#39;xss&#39;);&lt;/script&gt;", InputSanitizer.sanitizeHtml("<script>alert('xss');</script>"));
    ...
    void testSanitizeSql() {
        assertEquals("SELECT name FROM users WHERE id = &#39;1 OR 1=1--&#39;", InputSanitizer.sanitizeSql("SELECT name FROM users WHERE id = '1 OR 1=1--'"));
    ...
    void testSanitizeUrl() {
        assertEquals("http%3A%2F%2Fexample.com%3Fparam%3Dvalue%26another%3Dtest", InputSanitizer.sanitizeUrl("http://example.com?param=value&another=test"));
    ...
    void testSanitizeFilePath() {
        ...
        assertEquals("C%3A%5CUsers%5Ctest%5Cfile.txt", InputSanitizer.sanitizeFilePath("C:\\Users\\test\\file.txt"));

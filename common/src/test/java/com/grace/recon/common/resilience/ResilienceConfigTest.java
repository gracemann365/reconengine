...
class ResilienceConfigTest {
  ...
  void testExternalServiceCircuitBreakerConfigBean() {
    CircuitBreakerConfig config =
        applicationContext.getBean(
            "externalServiceCircuitBreakerConfig", CircuitBreakerConfig.class);
  ...
  void testDefaultCircuitBreakerConfigBean() {
    CircuitBreakerConfig config =
        applicationContext.getBean("defaultCircuitBreakerConfig", CircuitBreakerConfig.class);
    assertNotNull(config);
    assertEquals(
        CircuitBreakerConfig.ofDefaults().getFailureRateThreshold(),
  ...
  void testLongRunningOperationTimeLimiterConfigBean() {
    TimeLimiterConfig config =
        applicationContext.getBean(
            "longRunningOperationTimeLimiterConfig", TimeLimiterConfig.class);
    assertNotNull(config);
  ...
  void testDefaultTimeLimiterConfigBean() {
    TimeLimiterConfig config =
        applicationContext.getBean("defaultTimeLimiterConfig", TimeLimiterConfig.class);
    assertNotNull(config);

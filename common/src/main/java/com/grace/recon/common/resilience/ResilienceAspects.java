...
/**
 * Spring AOP aspects to apply Resilience4j annotations ( @CircuitBreaker, @Retry, @TimeLimiter) to
 * methods. This allows for declarative application of resilience patterns.
 */
@Component
@Aspect
public class ResilienceAspects {
  ...
  /**
   * Around advice for methods annotated with @CircuitBreaker. Applies circuit breaking logic to the
   * method execution.
   *
  ...
  /**
   * Around advice for methods annotated with @Retry. Applies retry logic to the method execution.
   *
   * @param joinPoint The proceeding join point.
   * @return The result of the method execution.
   * @throws Throwable If the method execution throws an exception.
  ...
  /**
   * Around advice for methods annotated with @TimeLimiter. Applies time limiting logic to the
   * method execution.
   *

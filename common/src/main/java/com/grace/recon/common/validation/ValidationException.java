...
/**
 * Custom exception specifically for validation failures. This exception is thrown when data fails
 * to meet defined validation rules. It extends {@link ReconciliationException} and can carry a list
 * of specific error messages from the validation process.
 */
public class ValidationException extends ReconciliationException {
  ...
  /**
   * Constructs a new validation exception with the specified detail message and a list of specific
   * validation errors.
   *

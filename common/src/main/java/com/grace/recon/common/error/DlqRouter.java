...
/**
 * Implements logic for routing failed messages to Dead Letter Queues (DLQs).
 * In a real-world scenario, this would involve publishing the failed message
 * to a dedicated DLQ topic in Kafka or another messaging system.
 */
public class DlqRouter {
     ...
     * This method simulates sending the message to a DLQ.
     *
     ...
     */
    public static void routeToDlq(String topic, String messageKey, String messageValue, String errorMessage) {
        log.error("Routing message to DLQ. Original Topic: {}, Key: {}, Error: {}. Message Content: {}",
                topic, messageKey, errorMessage, messageValue);
        ...
        System.out.println("Simulating DLQ routing for message with key: " + messageKey + ", error: " + errorMessage);
    }

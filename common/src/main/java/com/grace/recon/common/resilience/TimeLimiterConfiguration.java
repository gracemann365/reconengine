...
/**
 * Configuration class for Resilience4j TimeLimiter patterns.
 * Defines default and custom time limiter configurations.
 */
@Configuration
public class TimeLimiterConfiguration {

    /**
     * Defines a custom TimeLimiterConfig for long-running operations.
     * This configuration can be applied to specific time limiter instances.
     *
    ...
    /**
     * Defines a default TimeLimiterConfig.
     * This will be used if no specific configuration is provided for a time limiter instance.
     *

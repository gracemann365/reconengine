...
/**
 * A wrapper around SLF4J that facilitates structured logging.
 * This class allows logging messages with associated key-value pairs,
 * which can be easily parsed by log aggregation systems (e.g., ELK stack).
 */

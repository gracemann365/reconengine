...
/**
 * An enumeration of standardized error codes across the entire system. These codes provide a
 * consistent way to categorize and identify different types of errors that can occur during

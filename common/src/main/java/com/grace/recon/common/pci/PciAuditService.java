...
/**
 * Service for publishing PCI audit events. This ensures that all sensitive data access and
 * processing activities are logged for compliance and security monitoring.
 */
public class PciAuditService {
   ...
   */
  public static void logPciEvent(
      String eventType, String userId, String panId, Map<String, String> details) {

...
/**
 * A dedicated logger for critical audit events. This logger ensures that audit events
 * are clearly distinguishable from general application logs and can be routed
 * to specific destinations for security monitoring and compliance.
 */
public class AuditLogger {
    ...
    /**
     * Logs an audit event with a message and optional key-value pairs.
     * The key-value pairs are added to the MDC for structured logging.
     *

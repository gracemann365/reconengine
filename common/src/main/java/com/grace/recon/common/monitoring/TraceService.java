...
/**
 * Service for managing and creating OpenTelemetry spans and traces. This enables distributed
 * tracing across microservices to monitor request flows and identify performance bottlenecks.
 */
@Service
public class TraceService {
  ...
  /**
   * Starts a new span and makes it the current span in the context. The returned Scope must be
   * closed to end the span's active state.
   *
   * @param spanName The name of the span.

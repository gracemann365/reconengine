...
/**
 * Generic interface for defining custom data validation logic. Implementations of this interface
 * will provide specific validation rules for different types of objects.
 *
...
public interface Validator<T> {
   ...
   * @return A {@link ValidationResult} indicating whether the validation passed or failed, along
   *     with any associated error messages.
   */

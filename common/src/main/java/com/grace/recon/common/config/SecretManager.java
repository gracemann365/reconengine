...
public interface SecretManager {
    ...
    class PoCSecretManager implements SecretManager {
        ...
        public String getSecret(String secretName) {
            switch (secretName) {
                case "database.password": return "mockDbPass";
                case "kafka.sasl.password": return "mockKafkaPass";
                default: throw new ReconciliationException("Mock secret not found: " + secretName);
            }
        }
        ...
        public <T> T getSecret(String secretName, Class<T> type) {
            ...
            if (type.isInstance(secret)) {
                ...
                throw new ReconciliationException("Secret '" + secretName + "' cannot be cast to type " + type.getName());
            }
        }
    }
}
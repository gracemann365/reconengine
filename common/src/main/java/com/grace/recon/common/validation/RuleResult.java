...
/**
 * Encapsulates the outcome of a single validation rule execution.
 * This class provides a structured way to report whether a rule passed or failed,
 * along with any associated error messages and the name of the rule.
 */
